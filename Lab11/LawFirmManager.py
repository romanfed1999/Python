...
class LawFirmManager:
    ...
    def find_lawyer_by_name(self, name_to_compare):
        return list(filter(0lambda lawyer: lawyer.name.startwith(self, beg=0, end=1) == name_to_compare,
...
LawFirmManager.print_list(law_firm_manager.find_lawyer_by_name("M"))
